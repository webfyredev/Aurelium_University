...
export default function About_Us(){
    return(
        <>
            ...
            <div className="w-full p-15 bg-white flex flex-col items-center">
            ...
            <div className="w-full p-15 bg-purple-950 border-1 flex flex-col items-center">
            ...
            <div className="w-full mt-5 p-10 bg-gradient-to-r from-slate-50 to-purple-50 flex flex-col items-center">
                ...
                <div className="w-20 my-3 border-2 border-purple-700"></div>
                <div className="mt-5 w-[90%] p-5">
                    <video src="" controls className="w-full h-120 border-1 rounded-lg object-cover"></video>
                </div> 
            </div>
            <div className="w-full px-5 py-15 flex flex-col items-center bg-gradient-to-r from-slate-50 to-purple-50">
                <h4 className="font-semibold text-xs text-spacing-5 mt-5 text-purple-600 mb-3">
            ...
            <div className="w-full flex flex-col items-center p-10 bg-white">
                <h4 className="font-semibold text-xs text-spacing-5 mt-5 text-purple-600 mb-3">
                    COMMUNITY IMPACT
                </h4>
                <h2 className="text-3xl font-bold text-purple-950">
