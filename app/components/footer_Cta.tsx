...
interface ctaProps {
    ...
    text : string,
    btn_text1 : string,
    btn_text1_link :string,
    btn_text2_link : string,
    btn_text2 : string
}
export default function FooterCTA({title, text, btn_text1, btn_text2, btn_text1_link, btn_text2_link}:ctaProps){
    return(
        <>
