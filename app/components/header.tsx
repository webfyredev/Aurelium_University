        ...
        <>
            <div className="w-full h-110 mt-16 mb-5 relative">
                ...
                <div className="absolute w-full h-full top-0 left-0 absolute inset-0 bg-gradient-to-b from-purple-900/50 to-purple-900/60">
                    <div className="w-90 md:w-150 h-auto relative top-45 left-[5%] md:left-[15%] lg:left-[28%] p-5 flex flex-col items-center space-y-4">
                        <h3 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white text-center">
                            {title}
                        </h3>
                        <p className="text-purple-100 text-sm hidden md:flex">
                            {text}
                        </p>
                    </div>
                </div>
