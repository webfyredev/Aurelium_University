...
export default function Home() {
  ...
  return (
    ...
    <img  src="/about/about1.webp" alt="About_Us" className="w-1/2 h-95 rounded-md hover:scale-102 transition duration-300" />
    ...
    <div className="w-full p-10 bg-gradient-to-r from-slate-50 to-purple-50 flex flex-col items-center">
      ...
      <div className="w-full mt-5 p-5 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {programs.map((data, index) => (
          <div key={index} className="rounded-md bg-white flex flex-col shadow-sm group overflow-hidden hover:shadow-lg transition duration-300">
    ...
    <div className="bg-white w-full p-10 flex flex-col items-center">
        ...
        <div className="w-full mt-10  px-5 py-10 flex flex-col items-center">
            <h4 className="font-semibold text-xs text-spacing-5 mt-5 text-purple-600">
              ACCESS FACILITIES
            </h4>
            <h2 className="text-4xl font-bold mt-2 text-purple-900">
