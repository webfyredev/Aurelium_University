        ...
        <>
            <div className="flex flex-col rounded-xl overflow-hidden shadow-lg relative hover:shadow-xl transition">
                ...
                <div className="p-4 rounded-b-xl flex flex-col space-y-2">
                    ...
                    <a href="" className="flex items-center text-[10px] space-x-3 text-gray-500 font-semibold text-purple-950 hover:text-purple-800 transition">Read More <FaArrowRight  className=" ml-1"/></a>
                    </div>
                </div>
            </div>
        </>
